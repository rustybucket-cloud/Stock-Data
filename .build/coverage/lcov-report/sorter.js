var addSorting = function() {
  ...
  function loadColumns() {
    var colNodes = getTableHeader().querySelectorAll("th"), colNode, cols2 = [], col, i;
  ...
  function enableUI() {
    var i, el, ithSorter = function ithSorter2(i2) {
      var col = cols[i2];
      return function() {
        var desc = col.defaultDescSort;
        if (currentSort.index === i2) {
          desc = !currentSort.desc;
        }
        sortByIndex(i2, desc);
        removeSortIndicators();
        currentSort.index = i2;
